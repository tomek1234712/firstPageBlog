  ...
  <section>
    <div id="welcome" class="panel">
      <section>
        ...
        <iframe src="http://opensolution.org/dashboard-iframe.html?sLang=<?php echo $config['admin_lang']; ?>&amp;sUrl=<?php echo $config['url_domain']; ?>&amp;sScript=Quick.Cms.Ext&amp;sVersion=<?php echo $config['version'].'&mParam='.$config['url_param'].( defined( 'DEVELOPER_MODE' ) ? '&amp;bDeveloper=' : null ); ?>"></iframe>
        <!-- LICENSE REQUIREMENTS, DONT DELETE OR HIDE THIS IFRAME AND CONTENT OF THIS IFRAME -->
      </section>
    </div>
  </section>
