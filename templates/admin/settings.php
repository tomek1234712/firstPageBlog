...
<section id="body" class="settings">
  ...
  <form action="?p=<?php echo $_GET['p']; ?>" name="form" method="post" class="main-form" onsubmit="return checkLoginChange( this );">
    <fieldset>
      ...
      <ul class="tabs">
        <!-- tabs start -->
        <?php echo ( isset( $config['disable_settings_tab_pages'] ) ? null : '<li id="pages" class="selected"><a href="#">'.$lang['Pages'].'</a></li>' ); ?>
        <li id="loging"<?php echo ( isset( $config['disable_settings_tab_pages'] ) ? ' class="selected"' : null ); ?>><a href="#"><?php echo $lang['Loging']; ?></a></li>
      ...
      $(function(){
        displayTabInit();
        $( ".main-form" ).quickform({bLiveCheck:false});
      });
      </script>
      ...
      <ul id="tab-pages" class="forms list">
        ...
        <li>
          ...
          <select name="page_search" id="sSearchPage">
            <option value=""><?php echo $lang['none']; ?></option>
            <?php echo $oPage->listPagesSelectAdmin( $config['page_search'] ); ?>
          </select>
        </li>
        <li>
          <label for="sSitemapPage"><?php echo $lang['Site_map_page']; ?></label>
          <select name="page_sitemap" id="sSitemapPage">
            <option value=""><?php echo $lang['none']; ?></option>
            <?php echo $oPage->listPagesSelectAdmin( $config['page_sitemap'] ); ?>
          </select>
        </li>
        <li>
            <label for="sContactPage"><?php echo $lang['Contact_page']; ?></label>
            <select name="page_contact" id="sContactPage">
              <option value=""><?php echo $lang['none']; ?></option>
              <?php echo $oPage->listPagesSelectAdmin( $config['page_contact'] ); ?>
            </select>
          </li>
          <li>
          <label for="sTagsPage"><?php echo $lang['Tags_page']; ?></label>
          <select name="page_tags" id="sTagsPage">
            <option value=""><?php echo $lang['none']; ?></option>
            <?php echo $oPage->listPagesSelectAdmin( $config['page_tags'] ); ?>
          </select>
        </li>
        <!-- tab pages -->
      </ul>
      ...
      <ul id="tab-options" class="forms list">
        <li>
          <label for="display_editing_options">Put here field description</label>
          <select name="display_editing_options" id="display_editing_options">
            <?php echo getYesNoSelect( $config['display_editing_options'] ); ?>
          </select>
